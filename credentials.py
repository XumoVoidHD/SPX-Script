...
# Changeable Values
date = "20250321"                   # Date of contract (YYYY-MM-DD)
...
call_sl = 5                        # From where the call stop loss should start from (15 here means 15% of entry price)
call_entry_price_changes_by = 99     # What % should call entry premium price should change by to update the trailing %
call_change_sl_by = 10               # What % of entry price should call sl change when trailing stop loss updates
put_sl = 5                         # From where the put stop loss should start from (15 here means 15% of entry price)
put_entry_price_changes_by = 99      # What % should put entry premium price should change by to update the trailing %
